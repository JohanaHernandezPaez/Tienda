...
public class UsuariosDTO {
	...
	//DTO es un patrón que habla de las clases básicas dónde se hace referencia a los atributos de los usuarios solo van los constructores, getter and setter.
